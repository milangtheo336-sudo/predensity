...
contract BetWith1HBARScript is Script {
    function run() external returns (uint256) {
        uint256 privateKey = vm.envUint("MAINNET_PRIVATE_KEY");
        address contractAddress = vm.envAddress("MAINNET_MARKET_ADDRESS_V3_FIXED");
        
        console.log("=== Bet with 1 HBAR ===");
        ...
        // Use 1 HBAR as stake
        uint256 stakeAmount = 1 ether; // 1 HBAR
