...
contract DeployPredensityPredictionMarketMainnetScript is Script {
    function run() external returns (address) {
        ...
        console.log("Deploying PredensityPredictionMarket to MAINNET...");
        ...
        console.log("PredensityPredictionMarket deployed to:", address(predictionMarket));
