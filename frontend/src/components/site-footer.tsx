...
const SOCIAL_LINKS = [
  ...
  {
    label: 'TikTok',
    href: 'https://tiktok.com/@predensity',
  ...
  return (
    <footer className="bg-white dark:bg-[#0a0a0a] pb-32 md:pb-10">
      ...
      <div className="max-w-5xl mx-auto px-5 pt-10">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-6 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><a href="https://tiktok.com/@predensity" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors">TikTok</a></li>
        ...
        {/* Bottom bar */}
        <div className="flex items-center justify-between py-4 border-t border-gray-200 dark:border-white/[0.06]">
          <p className="text-xs text-gray-400 dark:text-gray-500">
            © {new Date().getFullYear()} Predensity. All rights reserved.
          </p>
          <button
            onClick={scrollToTop}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-gray-100 dark:bg-white/[0.06] text-xs font-semibold text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/10 transition-colors"
          >
            Back to top
