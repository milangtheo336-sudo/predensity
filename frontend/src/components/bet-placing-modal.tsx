  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-neutral-900/80 backdrop-blur-xl border border-gray-200 dark:border-white/[0.08] rounded-2xl p-8 w-96 max-w-[90vw] relative shadow-2xl">
        ...
        {/* Title */}
        <h3 className="text-xl font-bold text-gray-900 dark:text-white text-center mb-3">Bet in progress</h3>

        {/* Description */}
        <div className="text-center text-gray-500 dark:text-gray-400 space-y-1">
          <p>Your bet is being processed.</p>
          <p className="text-sm text-gray-400 dark:text-gray-500">It takes a couple of minutes to complete.</p>
        </div>
      </div>
    </div>
  );
