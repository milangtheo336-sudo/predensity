...
export default function OnboardingPage() {
  ...
  const toWin = (parseFloat(selectedAmount) * 100 / (selectedSide === 'yes' ? currentOutcome.yesPrice : currentOutcome.noPrice)).toFixed(2);
            ...
            <div className="w-full max-w-sm bg-white rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="px-5 pt-5 pb-3">
                <div className="flex items-center gap-2 mb-1">
                  <Image src={currentOutcome.flag ?? MATCH.home.flag} alt="" width={28} height={20} className="rounded-sm object-cover w-7 h-5 flex-shrink-0" />
                  <div>
                ...
                <button
                  ...
                  className={`py-3 rounded-xl text-sm font-bold transition-all ${
                    selectedSide === 'yes'
                      ...
                      : 'bg-white border border-[#2ecc71]/40 text-[#2ecc71]'
                  }`}
                >
                ...
                <button
                  ...
                  className={`py-3 rounded-xl text-sm font-bold transition-all ${
                    selectedSide === 'no'
                      ...
                      : 'bg-white border border-[#ff6b35]/40 text-[#ff6b35]'
                  }`}
                >
              ...
              <div className="flex items-center justify-between px-5 pb-5">
                ...
                <span className="text-2xl font-extrabold text-[#2ecc71]">{toWin} <span className="text-sm font-semibold text-gray-400">USDC</span></span>
              </div>
