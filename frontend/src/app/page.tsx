...
import { Search, TrendingUp, ShieldCheck, Bot, User, LineChart, Target, Flashlight, Radio, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#2980b9] selection:text-white">
      ...
      >
        ...
        <span className="font-semibold text-white group-hover:text-[#2980b9] transition-colors">
          Get in touch <span className="inline-block transition-transform group-hover:translate-x-1">ΓåÆ</span>
        </span>
      </a>
      ...
      <main className="max-w-7xl mx-auto px-6 mt-16 md:mt-24 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative animate-float mt-8 md:mt-0">
          ...
          <div className="absolute -top-12 -left-4 md:-top-16 md:-left-12 z-20 animate-float" style={{ animationDelay: '1.5s' }}>
            <Image 
          ...
          <div className="absolute -bottom-8 -right-4 md:-bottom-12 md:-right-8 z-20 animate-float" style={{ animationDelay: '3s' }}>
            <Image 
      ...
      <section id="predictive-efficiency" className="max-w-6xl mx-auto px-6 mt-48">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mx-auto">
            Turns bold predictions into a real-time probability map of token prices, combining AI agents and human insight to surface what's next.
          </p>
        </div>
        ...
        <div className="relative animate-float">
          ...
          />
          {/* Thumbs Up Left */}
          <div className="absolute top-1/2 -left-6 md:-left-16 z-20 -translate-y-1/2 animate-float" style={{ animationDelay: '1s' }}>
            <Image 
          ...
          {/* Thumbs Down Right */}
          <div className="absolute top-1/3 -right-6 md:-right-16 z-20 animate-float" style={{ animationDelay: '2.5s' }}>
            <Image 
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 text-center md:text-left">
          <div className="space-y-3">
            ...
            <Link href="https://yt0-2.gitbook.io/yt-docs/how-it-works/forecasting-model" className="inline-block text-xs font-semibold text-[#2980b9] hover:text-white transition-colors">Learn more ΓåÆ</Link>
          </div>
          <div className="space-y-3">
            <div className="w-8 h-8 flex items-center justify-center text-white mb-2 mx-auto md:mx-0">
              <User size={24} />
            ...
            <Link href="https://yt0-2.gitbook.io/yt-docs/how-it-works/betting" className="inline-block text-xs font-semibold text-[#2980b9] hover:text-white transition-colors">Learn more ΓåÆ</Link>
          </div>
          <div className="space-y-3">
            <div className="w-8 h-8 flex items-center justify-center text-white mb-2 mx-auto md:mx-0">
              <LineChart size={24} />
            ...
            <Link href="https://yt0-2.gitbook.io/yt-docs/how-it-works/probability-map" className="inline-block text-xs font-semibold text-[#2980b9] hover:text-white transition-colors">Learn more ΓåÆ</Link>
          </div>
          <div className="space-y-3">
            <div className="w-8 h-8 flex items-center justify-center text-white mb-2 mx-auto md:mx-0">
              <Target size={24} />
            ...
            <Link href="https://yt0-2.gitbook.io/yt-docs/prediction-resolution/payout-system" className="inline-block text-xs font-semibold text-[#2980b9] hover:text-white transition-colors">Learn more ΓåÆ</Link>
          </div>
        </div>
      </section>
      ...
      <section id="infofi" className="max-w-6xl mx-auto px-6 mt-48">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-lg text-gray-400 leading-relaxed max-w-2xl mx-auto mt-4">
            Predensity is built on the InfoFi principle that aligned incentives produce accurate market intelligence by aggregating diverse trader perspectives
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#111] border border-white/5 rounded-3xl p-12 text-center hover:bg-[#151515] transition-colors">
            <div className="h-48 flex items-center justify-center mb-8 animate-float" style={{ animationDelay: '0.5s' }}>
          ...
          <div className="bg-[#111] border border-white/5 rounded-3xl p-12 text-center hover:bg-[#151515] transition-colors">
            <div className="h-48 flex items-center justify-center mb-8 animate-float" style={{ animationDelay: '2s' }}>
      ...
      <section id="signals" className="max-w-6xl mx-auto px-6 mt-48">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#111] border border-white/5 rounded-2xl p-8 text-center hover:bg-[#151515] transition-colors">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Access an open stream of token-level price forecasts ΓÇö a shared intelligence layer for the crypto ecosystem
            </p>
          </div>
        </div>
      </section>
